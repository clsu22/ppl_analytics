...
Usage: target_and_splitter.py --file_path_1=<file_path_1> --file_path_2=<file_path_2> --clean_path=<clean_path>
...
print("Start Target and Splitter script")

#for testing
# file_path_1='../Glentel Inc/HR Analytics - Documents/Capstone Data/V2 data 5.1.2020/' 
# file_path_2='../Glentel Inc/HR Analytics - Documents/Capstone Data/ubc_mds_team_share/make_processed/'
# clean_path='../Glentel Inc/HR Analytics - Documents/Capstone Data/ubc_mds_team_share/make_processed/'
...
#### END OF HELPER FUNCTIONS
    ...
    resume_employee = pd.read_csv(file_path_2+'english_clean_resumes.csv',index_col =0).clean_names()
...
print("Finish Target and Splitter script")