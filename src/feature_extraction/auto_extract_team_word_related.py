...
Example:
python auto_extract_team_word_related.py --file_path="data/input/" --output_path="data/output/"
...
###################################################################################################    
    ...
    print()
    print('Runing "TEAM" related features')
    ...
    print("Step2: Generating features: team_player_phrase & team_word")
    # Generate Features
    ...
    # Exporting Results
    output_path_filename = output_path+"auto_team_word_related_features.csv"
