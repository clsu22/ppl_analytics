...
"""
This script is used to read all resumes in Career Builder (Resumes) folder
"""
...
def main():
    ...
    # Load matching list
    matchtable = pd.read_excel(
        "C:/Users/NIV/Documents/02-HR-project/data/matching_list_maunually"
        "-checked_V1.2.xlsx")
    ...
    df3.to_csv(
        ...
        "/05182020_all_language_resumes_V1.0.csv",
        index=False)
    df4.to_csv(
